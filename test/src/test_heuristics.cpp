...
static void test_match()
{
     ...
     */
    {
        ...
        std::vector<std::vector<uint8_t>> b1(std::vector<std::vector<uint8_t>>(
                2, std::vector<uint8_t>(1, 0)));
        b1[0][0] = 5;
        b1[1][0] = 5;
        dict->insert(new Block(2, 1, b1));

        std::vector<std::vector<uint8_t>> b2(std::vector<std::vector<uint8_t>>(
                1, std::vector<uint8_t>(2, 0)));
        b2[0][0] = 5;
        b2[0][1] = 6;
        dict->insert(new Block(1, 2, b2));

        std::vector<std::vector<uint8_t>> b3(std::vector<std::vector<uint8_t>>(
                2, std::vector<uint8_t>(2, 0)));
        b3[0][0] = 5;
        b3[0][1] = 6;
        b3[1][0] = 5;
        b3[1][1] = 5;
        ...
        heuristic::match::top_left_mse(dict, tolerance, image, gp, &common_block_idx, &best_block);
